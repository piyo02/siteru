...
<body>
    ...
    <div class="container mx-auto px-3 mt-5">
        <div class="grid grid-cols-1 md:grid-rows-2 lg:grid-rows-1 lg:grid-cols-12 gap-6">
            <div class="lg:row-start-1 lg:col-span-9">
                <div id="vs-ms">
                    <h4 class="text-2xl font-bold mb-3" style="color: #10306C">Visi dan Misi</h4>
                    {!! $vs_ms_content !!}
                </div>
                <div id="tgs-fgs">
                    <h4 class="text-2xl font-bold mt-10 mb-3" style="color: #10306C">Tugas dan Fungsi</h4>
                    {!! $tgs_fgs_content !!}
                </div>
                <div id="mt-lbg">
                    <h4 class="text-2xl font-bold mt-10 mb-3" style="color: #10306C">Motto dan Lambang</h4>
                    {!! $mt_lbg_content !!}
                </div>
                <div id="str-org">
                    <h4 class="text-2xl font-bold mt-10 mb-3" style="color: #10306C">Struktur Organisasi</h4>
                    <img src="{{ asset('storage' . '/' . $str_org->value) }}" alt="">
                </div>
            </div>
            <div class="row-start-1 lg:col-span-3 lg:sticky lg:top-5">
                <div class="bg-white rounded-sm shadow-sm border p-6">
                    <h5 class="text-xl font-bold mb-4 mt-0">Konten</h5>
                    <ul class="divide-y-2 divide-gray-100 text-sm">
                        <li class="py-3 hover:text-blue-900">
                            <a href="#vs-ms">Visi dan Misi</a>
                        </li>
                        <li class="py-3 hover:text-blue-900">
                            <a href="#tgs-fgs">Tugas dan Fungsi</a>
                        </li>
                        <li class="py-3 hover:text-blue-900">
                            <a href="#mt-lbg">Motto dan Lambang</a>
                        </li>
                        <li class="py-3 hover:text-blue-900">
                            <a href="#str-org">Struktur Organisasi</a>
                        </li>
                    </ul>
                </div>
            </div>
