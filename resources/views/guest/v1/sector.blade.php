    ...
    <div class="container mx-auto px-3 mt-5">
        <div class="mx-auto mt-4  rounded">
            <ul id="tabs" class="justify-center inline-flex w-full px-1 pt-2 ">
                <li class="px-4 py-2 -mb-px font-semibold text-gray-800 border-b-2 border-blue-400 rounded-t opacity-50"><a id="default-tab" href="#tgs-fgs">Tugas dan Fungsi</a></li>
                <li class="px-4 py-2 font-semibold text-gray-800 rounded-t opacity-50"><a href="#program">Program</a></li>
                <li class="px-4 py-2 font-semibold text-gray-800 rounded-t opacity-50"><a href="#structure">Struktur</a></li>
                <li class="px-4 py-2 font-semibold text-gray-800 rounded-t opacity-50"><a href="#contacts">Kontak</a></li>
            </ul>

            <div id="tab-contents">
                <div id="tgs-fgs" class="p-4 h-full">
                    <div>
                        {!! $job !!}
                    </div>
                    <div>
                ...
                <div id="program" class="hidden p-4">
                    {!! $program !!}
                </div>
                <div id="structure" class="hidden p-4">
                    <div class="border rounded">
                        <img src="{{ asset('storage') . '/' . $sector->structure }}" alt="">
                    </div>
                </div>
                <div id="contacts" class="hidden p-4">
                    <div class="border bg-white rounded-sm shadow-lg mt-5 w-1/3">
                        <ul class="divide-y-2 divide-gray-100">
                            @foreach ($contacts as $contact)
                                <li class="flex justify-between p-3">
                                    {{ $contact->contact }}
                                    <img src="{{ asset('storage') . '/' . $contact->contact_type->icon }}" alt="" width="25px" height="25px">
                                </li>
                            @endforeach
                        </ul>
                    </div>
