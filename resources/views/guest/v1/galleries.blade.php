...
<body>
    ...
    {{-- navbar --}}
    <div class="w-full text-gray-700 bg-white shadow-lg border-b-2 border-yellow-400">
    ...
    <div class="absolute mx-auto flex justify-center items-center filter blur-2xl animate-pulse duration-500 transition w-full">
    ...
    <div class="container px-6">
        <div class="grid lg:grid-cols-3 gap-4">
            ...
            <div class="">
                <div class="shadow-lg mx-auto flex justify-center md:mb-8 mt-4 bg-white rounded-lg items-center relative md:p-0 p-8">
                    <div class="h-full relative">
                        <div class="py-2 px-2">
                            <div class="flex justify-between items-center py-2">
                                <div class="relative mt-1 flex">
                                    <div class="mr-2">
                                        <img src="https://avatars.githubusercontent.com/u/68494287?v=4" alt="saman sayyar" class="w-10 h-10 rounded-full object-cover">
                                    </div>
                        ...
                        <div class="">
                            <div class="flex justify-between items-start p-2 pt-5">
                                <div class="flex space-x-2 items-center"></div>
                                <div class="flex space-x-2 items-center">
                                    <a href="/publikasi/galeri/{{ $gallery->slug }}" class="text-xs button bg-blue-800 rounded py-1 px-3 text-white">
                                        selengkapnya
                                    </a>
                                </div>
                            </div>
