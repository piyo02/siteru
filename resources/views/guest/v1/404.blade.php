        ...
        <div class="flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
            <div class="w-full md:w-1/2">
                ...
                <div class="mb-10 md:mb-20 text-gray-600 font-light">
                    <h1 class="font-black uppercase text-3xl lg:text-5xl text-indigo-700 mb-10">그런 앱은<br>없어 보이네요</h1>
                    <p>찾고 계시는 어플리케이션이 없어진 것 같네요.</p>
                    <p>홈으로 돌아가서 다시 찾아 보세요.</p>
                </div>
                <div class="mb-20 md:mb-0">
                    <button class="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-blue-500 hover:text-blue-600">홈으로 돌아가기</button>
                </div>
            </div>
