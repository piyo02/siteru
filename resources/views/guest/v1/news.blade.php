...
<body>
    ...
    {{-- news --}}
    <div class="container lg:px-32 px-7 mt-12">
        @foreach ($newses as $news)
        <main class="flex items-center w-full h-full bg-white">
            <div class="border-t border-b grid lg:grid-cols-2 gap-8">
                <div class="flex flex-col justify-start">
                    <div class="flex flex-col w-full object-cover h-4/6 justify-items-start border rounded-lg overflow-hidden" style="min-heigth:320px">
                        <img class="w-full h-full object-cover" src='{{ asset("storage") . "/" . $news->thumbnail }}' alt='nike shoes' >
                    </div>
                </div>
                <div class="flex flex-col">
                    <div class="flex flex-col gap-4">
                        <h1 class="capitalize text-2xl font-extrabold">{{ $news->title }}</h1>
                        <p class="text-lg text-gray-500	">
                            {{ $news->description }}
                        </p>
                        <div class="flex items-center gap-4 my-6 cursor-pointer ">
                            <a href="/publikasi/berita/{{$news->slug}}" class="bg-blue-600 px-5 py-3 text-xs text-white rounded-lg text-center">Baca Selengkapnya</a>
                        </div>
                    </div>
                </div>
            </div>
