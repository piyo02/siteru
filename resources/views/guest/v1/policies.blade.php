        ...
        <main
            ...
            <div class="flex-1 p-4 lg:p-6">
                <div class="text-lg text-white mb-8 flex items-center">
                    ...
                    <div class="ml-4 font-bold">Kebijakan</div>
                </div>
                <div class="grid grid-rows-4 grid-cols-1 gap-4 md:grid-rows-2 md:grid-cols-2">
                    <div
                        ...
                        <div class="text-white text-lg font-medium mb-2 mt-4">Kebijakan</div>
                        <div class="text-white font-normal text-sm mb-5">
                            Writing the actual code for the site, as it controls everything
                            that happens behind the scenes of the site.
                        </div>
                        <div>
                            <a href="#" class="text-xs text-white bg-blue-800 p-2 rounded-lg">Download</a>
                        </div>
                    </div>
                </div>
            </div>
